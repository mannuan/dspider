...
fl_shop2 = Fieldlist(
    Field(fieldname=FieldName.SHOP_ADDRESS, css_selector='#basic-info > div.expand-info.address', is_focus=True, is_info=True),
...
page_shop_2 = Page(name='大众点评美食店铺详情页面', fieldlist=fl_shop2)
...
page_comment_1 = Page(name='大众点评美食评论列表', fieldlist=fl_comment1, listcssselector=ListCssSelector(list_css_selector='#review-list > div.review-list-container > div.review-list-main > div.reviews-wrapper > div.reviews-items > ul > li'), mongodb=Mongodb(db=TravelDriver.db, collection=TravelDriver.comments_collection), is_save=True)
